...
/**
 * Servlet implementation class SelectTableInfo30
 */
@WebServlet("/SelectTableInfo30")
public class SelectTableInfo30 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectTableInfo30() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			java.sql.Date StartDate = DataUtil.getDayBefore30(EndDate);
