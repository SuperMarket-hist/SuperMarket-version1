...
/**
 * Servlet Filter implementation class FilterOfficePage
 */
@WebFilter("/SuperMarket/OfficePage/*")
public class FilterOfficePage implements Filter {

    /**
     * Default constructor. 
     */
    public FilterOfficePage() {
